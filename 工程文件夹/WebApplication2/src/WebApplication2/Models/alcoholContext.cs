...
namespace WebApplication2.Models
{
    public partial class alcoholContext : DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(@"Data Source=3078696.nat123.cc,33143;Initial Catalog=alcohol;User ID=sa;Password=sa1234");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AreaCounty>(entity =>
            {
                entity.HasKey(e => e.ObjId)
                    .HasName("PK__AreaCoun__4616479E2F0E401E");
            ...
            {
                entity.HasKey(e => e.ObjId)
                    .HasName("PK__City__4616479E4A08F09F");
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.Property(e => e.CustomerId).HasColumnType("varchar(256)");

                entity.Property(e => e.CustomerPassword).HasColumnType("varchar(256)");

                entity.Property(e => e.CustomerSex).HasColumnType("varchar(512)");

                entity.Property(e => e.CustomerTel).HasColumnType("char(20)");

                entity.Property(e => e.CustomerUserName).HasColumnType("varchar(512)");
            ...
            {
                entity.HasKey(e => e.ObjId)
                    .HasName("PK__Nation__4616479ECBC421F0");

                entity.Property(e => e.Nname).HasMaxLength(30);
            });
            ...
            {
                entity.HasKey(e => e.ObjId)
                    .HasName("PK__Province__4616479EE4D4D6C1");

                entity.Property(e => e.Pname).HasMaxLength(30);
            });
